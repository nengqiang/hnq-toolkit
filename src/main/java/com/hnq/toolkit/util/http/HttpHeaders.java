...
public class HttpHeaders {
    ...
    public static List<String> getHeaderValues(@Nonnull final HttpRequest request,
    ...
    public static String getHeaderValue(@Nonnull final HttpRequest request,
                                        @Nonnull final String name) {
        List<String> headerValues = getHeaderValues(request, name);

        return CollectionUtils.isNotEmpty(headerValues) ? headerValues.get(0) : null;
    }

    public static List<String> getHeaderValues(@Nonnull final HttpResponse response,
                                               @Nonnull final String name) {
    ...
    public static String getHeaderValue(@Nonnull final HttpResponse response,
                                        @Nonnull final String name) {
        List<String> headerValues = getHeaderValues(response, name);
